...
![](./doc/assets/Create-PR.png)
![](./doc/assets/Check-branch-PR.png)
...
![](./doc/assets/Create-review-request.png)
![](./doc/assets/Review-request.png)
5. **Watch for reactions in the thread** for this review request, correct comments when there are any. If no one responds after several days, relaunch the request. When the PR is approved, you can merge the PR.
...
3. `git rebase origin/xxx` : Replace xxx with the name of the branch to be rebased, often `develop` or `main`
